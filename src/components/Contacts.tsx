...
export default function Contacts({ isTeamView, homeFilterPreference, onColdCallClick, onViewHistory, onSendEmail, onViewContact, onDeleteContact }: ContactsProps) {
    ...
    <div className="flex-1 overflow-hidden flex flex-col p-6">
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between mb-6">
        ...
        <button
          ...
          className="group flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 hover:shadow-md transition-all shadow-sm"
        >
          <Icon
