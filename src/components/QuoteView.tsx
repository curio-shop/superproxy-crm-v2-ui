                ...
                <div className="group absolute bottom-full right-[-3.5rem] mb-3 w-[420px] bg-white rounded-2xl shadow-2xl border border-blue-100 z-50 animate-in slide-in-from-bottom-4 fade-in duration-300">
                  ...
                  <div className="px-5 py-4 space-y-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold text-sm transition-all shadow-lg hover:shadow-xl active:scale-95"
                    >
