...
export default function Invoices({ isTeamView, homeFilterPreference, onPaymentReminderClick, onEmailInvoiceClick, onAskAIClick, onOpenTemplateBuilder, onDeleteInvoice }: InvoicesProps) {
