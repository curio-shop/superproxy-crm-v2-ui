            ...
            <div className="flex gap-3 items-center">
              ...
              {currentStep === 7 ? (
                <button
                  ...
                  className="group h-10 flex items-center gap-2 px-5 rounded-lg text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 hover:shadow-lg shadow-blue-600/20 transition-all focus:ring-2 focus:ring-blue-300 focus:outline-none active:scale-[0.98]"
                >
