                ...
                {selectedEmail.attachmentName && (
                  <div className="bg-gradient-to-br from-emerald-50/50 via-blue-50/30 to-amber-50/50 backdrop-blur-sm rounded-2xl p-5 border border-emerald-200/40 shadow-sm">
                    <div className="flex items-center gap-4">
                      ...
                      <button className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white flex items-center justify-center transition-all shadow-sm hover:shadow-md">
