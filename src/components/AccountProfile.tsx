...
interface AccountProfileProps {
  activeTab: 'profile' | 'preferences' | 'security' | 'billing' | 'workspaces' | 'voice' | 'contact';
  onTabChange: (tab: 'profile' | 'preferences' | 'security' | 'billing' | 'workspaces' | 'voice' | 'contact') => void;
  onChatOpen: () => void;
